                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select dir = "ltr"  class="eng-format form-control" id = "productSize" name = "productSize">
                                                    ...
                                                    <option value="Women-26"> 26</option>
                                                    <option value="Women-27"> 27</option>
                                                    <option value="Women-28"> 28</option>
                                                    <option value="Women-29"> 29</option>
                                                    <option value="Women-30"> 30</option>
                                                    <option value="Women-31"> 31</option>
